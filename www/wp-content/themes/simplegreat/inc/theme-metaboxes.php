...
function pages_settings_inner_box( $post ) {
  ...
  echo '<p><input type="checkbox" id="page_fullwidth" name="page_fullwidth" '.$checked.' /> <label for="page_fullwidth">'.__( "Display this page content fullwidth", 'simplegreat' ).'</label></p>';

  $checked = '';
  if( $value_page_notdisplaytitle == true ) { 
    $checked = 'checked = "checked"';
  }
  echo '<p><input type="checkbox" id="page_notdisplaytitle" name="page_notdisplaytitle" '.$checked.' /> <label for="page_notdisplaytitle">'.__( "Don't display this page title (only show page content)", 'simplegreat' ).'</label></p>';
  ...
  echo '<p><label for="page_sidebarposition" style="display: inline-block; width: 150px;">'.__( "Page sidebar position: ", 'simplegreat' ).'</label>';
  echo '<select name="page_sidebarposition" id="page_sidebarposition">
        <option value="0"'.$selected_1.'>'.__( "Use theme control panel settings", 'simplegreat' ).'</option>
        <option value="left"'.$selected_2.'>'.__( "Left", 'simplegreat' ).'</option>
        <option value="right"'.$selected_3.'>'.__( "Right", 'simplegreat' ).'</option>
        <option value="disable"'.$selected_4.'>'.__( "Disable sidebar", 'simplegreat' ).'</option>
    </select></p>';

  echo '<label for="page_bgcolor" style="display: inline-block; height: 40px;">'.__( "Page background color: ", 'simplegreat' ).'</label> &nbsp;';
...
function post_settings_inner_box( $post ) {
  ...
  echo '<p><input type="checkbox" id="post_fullwidth" name="post_fullwidth" '.$checked.' /> <label for="post_fullwidth">'.__( "Display this post content fullwidth", 'simplegreat' ).'</label></p>';
  ...
  echo '<p><input type="checkbox" id="post_socialshare_disable" name="post_socialshare_disable" '.$checked.' /> <label for="post_socialshare_disable">'.__( "Disable social share counters and buttons on this post", 'simplegreat' ).'</label></p>';
  ...
  echo '<p><label for="post_sidebarposition" style="display: inline-block; width: 150px;">'.__( "Post sidebar position: ", 'simplegreat' ).'</label>';
  ...
  echo '<label for="post_bgcolor" style="display: inline-block; height: 40px;">'.__( "Post background color: ", 'simplegreat' ).'</label> &nbsp;';
