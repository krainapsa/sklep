    ...
    class IPANEL
    {
        ...
        { 
            ...
            if ($fonts_transient == false) {
              $fonts_transient = get_transient('ipanel_googleFonts');
            }
            
            if (count($fonts_transient) < 10) {
              
                $response = wp_remote_get(
                    'https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=AIzaSyCS0xneYocJ0wM3mQZWQ2FEqg_86h0jwrc',
                    array(
                        'sslverify' => false
                    )
                );
                ...
                if (!is_wp_error($response)) {
                    ...
                    set_transient('ipanel_googleFonts', $fonts_list, 60 * 60 * 24 * 2); // Cache 2 days
